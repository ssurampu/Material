...
public class AppRater {
    private final static String APP_TITLE = "'TagIt'";
    private final static String APP_PNAME = "com.srids.tagit";
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        tv.setText("If you enjoy using " + APP_TITLE + ", please take a moment to rate. Thanks for your support!");
        tv.setWidth(240);
